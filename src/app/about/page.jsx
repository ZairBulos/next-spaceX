...
export const metadata = {
  title: "About",
  description: "Learn about Next SpaceX, a web application for exploring SpaceX's world.",
};
      ...
      <section className="flex justify-center py-8 min-h-[82vh]">
        <div className="lg:w-[1024px] border rounded-lg p-10 shadow-lg shadow-white">
          ...
          <ul className="pl-8 list-disc">
            ...
            <li>
              <strong>No Sign-Up Required:</strong> Start exploring SpaceX data
              immediately without the need for registration.
            </li>
            <li>
              <strong>Reduced Network Requests:</strong> Our optimized platform
              minimizes unnecessary network requests, ensuring faster load times
              and efficient data retrieval.
            </li>
            <li>
              <strong>More Features:</strong> Stay tuned for additional features
              coming soon!
            </li>
          </ul>
        </div>
